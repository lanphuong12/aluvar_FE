    ...
    return (
      (P.chbreakpoint = function () {
        if (((r = e(window).width()), l.responsive.length)) {
          var i;
          if (
            (l.autoWidth === !1 && (i = l.item), r < l.responsive[0].breakpoint)
          )
          ...
          if ("undefined" != typeof c && null !== c)
            for (var n in c.settings)
              c.settings.hasOwnProperty(n) &&
                (("undefined" == typeof a[n] || null === a[n]) && (a[n] = l[n]),
                (l[n] = c.settings[n]));
      ...
      (n = {
        ...
        initialStyle: function () {
          ...
          "fade" === l.mode && ((l.autoWidth = !1), (l.slideEndAnimation = !1)),
            ...
            l.rtl === !0 && v.parent().addClass("lSrtl"),
            l.vertical
                ...
                if (P.calWidth(!0) > g) {
                  ...
                  if (a < s.find(".clone.right").length)
                    for (
                      ...
                      p--, o.eq(d).remove();
                  for (var c = s.find(".clone.right").length; a > c; c++)
                    s
                      .find(".lslide")
                      .eq(c)
                      .clone()
            ...
            (P.sSW = function () {
              (u = o.length),
                l.rtl === !0 && l.vertical === !1 && (S = "margin-left"),
                l.autoWidth === !1 && o.css(m, M + "px"),
            ...
            "slide" === l.mode
              ? (P.calSW(),
                P.sSW(),
                l.loop === !0 && ((b = e.slideValue()), this.move(s, b)),
                l.vertical === !1 && this.setHeight(s, !1))
              : (this.setHeight(s, !0),
                s.addClass("lSFade"),
                this.doCss() || (o.fadeOut(0), o.eq(p).fadeIn(0))),
            l.loop === !0 && "slide" === l.mode
          ...
          if (p * l.slideMove < u) {
            e.removeClass("active"),
              this.doCss() ||
                ...
                i !== !1 ||
                e.fadeOut(l.speed),
              (t = i === !0 ? p : p * l.slideMove);
            var n, a;
            i === !0 && ((n = e.length), (a = n - 1), t + 1 >= n && (t = a)),
              l.loop === !0 &&
                "slide" === l.mode &&
                ((t =
                  i === !0
        ...
        touchEnd: function (e) {
          if (
            ...
            (b -= e),
              b > f - g - l.slideMargin
                ? ((b = f - g - l.slideMargin), l.autoWidth === !1 && (i = !0))
                : 0 > b && (b = 0);
            var n = function (e) {
              var t = 0;
          ...
          if (!w) {
            ...
            v.find(".lightSlider").addClass("lsGrab"),
              v.on("mousedown", function (i) {
                return g > f && 0 !== f
                  ...
                  : void (
                      ...
                      ((t = l.vertical === !0 ? i.pageY : i.pageX),
                      (a = !0),
                      i.preventDefault
                        ? i.preventDefault()
                        : (i.returnValue = !1),
              ...
              e(window).on("mousemove", function (e) {
                a &&
                  ((n = l.vertical === !0 ? e.pageY : e.pageX),
                  i.touchMove(n, t));
              }),
              e(window).on("mouseup", function (s) {
                if (a) {
                  v
                    ...
                    .addClass("lsGrab"),
                    (a = !1),
                    (n = l.vertical === !0 ? s.pageY : s.pageX);
                  var o = n - t;
          ...
          if (w) {
            ...
            v.on("touchstart", function (e) {
              ...
              v.on("touchend", function () {
                if (g > f && 0 !== f) return !1;
                var n;
                (n = l.vertical === !0 ? t.pageY - i.pageY : t.pageX - i.pageX),
                  e.touchEnd(n);
              });
          }
        },
        build: function () {
          ...
          i.initialStyle(),
            this.doCss() &&
              (l.enableTouch === !0 && i.enableTouch(),
              l.enableDrag === !0 && i.enableDrag()),
